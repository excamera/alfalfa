source = frame_deps.cc  test_vector_reader.cc vp8_dixie_iface.c dixie.c modemv.c predict.c tokens.c dixie_loopfilter.c idct_add.c vpx_decoder.c vpx_image.c vpx_mem.c vpx_codec.c
objects = test_vector_reader.o vp8_dixie_iface.o dixie.o modemv.o predict.o tokens.o dixie_loopfilter.o idct_add.o vpx_decoder.o vpx_image.o vpx_mem.o vpx_codec.o
