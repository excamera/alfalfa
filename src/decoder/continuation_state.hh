...
private:
  ...
  Optional<RasterHandle> last_shown_;
...
public:
  ...
  ContinuationState( KeyFrame && frame, const Optional<RasterHandle> & raster,
                     const References & refs );
  ContinuationState( InterFrame && frame, const Optional<RasterHandle> & raster,
                     const References & refs );
  ...
  DependencyTracker get_frame_updated( void ) const;
};
