...
template <>
inline FrameHandle<KeyFrame> DecoderState::parse_and_apply<KeyFrame>( const UncompressedChunk & uncompressed_chunk )
{
  ...
  FrameHandle<KeyFrame> myframe( uncompressed_chunk.show_frame(),
...
template <>
inline FrameHandle<InterFrame> DecoderState::parse_and_apply<InterFrame>( const UncompressedChunk & uncompressed_chunk )
{
  ...
  FrameHandle<InterFrame> myframe( uncompressed_chunk.show_frame(),
				   uncompressed_chunk.experimental(),
		      		   width, height, first_partition );
